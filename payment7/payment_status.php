...
// Fetch order details
$slq_user = "SELECT callback_url FROM users WHERE id='$userid'";
...
curl_close($ch);
    ...
    $update_query = "UPDATE orders SET status='SUCCESS',utr='$utr_number' WHERE order_id='$order_id' AND user_id='$userid'";
