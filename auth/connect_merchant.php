                                    ...
                                    <div class="row" id="merchant">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <button type="submit" name="addmerchant"
                                                class="btn btn-primary btn-block">Add Merchant</button>
                                        </div>
                                    </div>
...
";
                                            ...
                                            if ($ssData && mysqli_num_rows($ssData) > 0) {
                                                $counter = 1;
                                                while ($merchant = mysqli_fetch_array($ssData)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo !empty($merchant['merchant_type']) ? strtoupper(htmlspecialchars($merchant['merchant_type'], ENT_QUOTES, 'UTF-8')) : ''; ?>
                                                        </td>
                                                        <td><?php echo !empty($merchant['number']) ? htmlspecialchars($merchant['number'], ENT_QUOTES, 'UTF-8') : ''; ?>
                                                        </td>
                                                        <td>
                                                            <button type="button"
                                                        ...
                                                        <td class="d-flex justify-content-center gap-10">
                                                            ...
                                                            if ($merchant['merchant_type'] == 'hdfc') {
                                                                ...
                                                                <form action="send_hdfcotp" method="post">
                                                                    <input type="hidden" name="hdfc_mobile"
                                                                        value="<?php echo $merchant['number']; ?>">

                                                                    <button class="btn ripple btn-primary px-2"
                                                                ...
                                                                <form action="send_phonepeotp" method="post">
                                                                    <input type="hidden" name="phonepe_mobile"
                                                                        value="<?php echo $merchant['number']; ?>">
                                                                ...
                                                                <form action="send_paytmotp" method="post">
                                                                    <input type="hidden" name="paytm_mobile"
                                                                        value="<?php echo $merchant['number']; ?>">
                                                                ...
                                                                <form action="send_bharatpeotp" method="post">
                                                                    <input type="hidden" name="bharatpe_mobile"
                                                                        value="<?php echo $merchant['number']; ?>">
                                                                ...
                                                                <form action="send_googlepayotp" method="post">
                                                                    <input type="hidden" name="googlepay_mobile"
                                                                        value="<?php echo $merchant['number']; ?>">
                                                                ...
                                                                <form action="send_freechargeotp" method="post">
                                                                    <input type="hidden" name="freecharge_mobile"
                                                                        value="<?php echo $merchant['number']; ?>">
                                                                ...
                                                                <form action="send_sbiotp" method="post">
                                                                    <input type="hidden" name="sbi_mobile"
                                                                        value="<?php echo $merchant['number']; ?>">
                                                                ...
                                                                <form action="send_mobikwikotp" method="post">
                                                                    <input type="hidden" name="mobikwik_mobile"
                                                                        value="<?php echo $merchant['number']; ?>">
                                                            ...
                                                            if ($merchant['merchant_type'] == 'hdfc') {
                                                                ...
                                                                <form method="POST"
                                                                    ...
                                                                    <button class="btn ripple btn-danger px-2"
