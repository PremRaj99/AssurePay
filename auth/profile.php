                ...
                <form class="row mb-4" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                  <div class="col-md-4 mb-3">
                    ...
                    <input type="text" placeholder="Username"
                      value="<?php echo htmlspecialchars($userdata['instance_id'], ENT_QUOTES, 'UTF-8'); ?>"
                      class="form-control" readonly>
                  </div>
                  <div class="col-md-4 mb-3">
                    <label>Mobile Number</label>
                    <input type="text" name="mobile" placeholder="Mobile Number"
                      value="<?php echo htmlspecialchars($userdata['mobile'], ENT_QUOTES, 'UTF-8'); ?>"
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="email" placeholder="Email Address"
                      ...
                      class="form-control input-solid" required readonly>
                  </div>
                  <div class="col-md-4 mb-3">
                    <label>Name</label>
                    <input type="text" placeholder="Name"
                      value="<?php echo htmlspecialchars($userdata['name'], ENT_QUOTES, 'UTF-8'); ?>"
                      class="form-control" readonly>
                  </div>
                  <div class="col-md-4 mb-3">
                    <label>Company Name</label>
                    <input type="text" placeholder="Company Name"
                      value="<?php echo htmlspecialchars($userdata['company'], ENT_QUOTES, 'UTF-8'); ?>"
                      class="form-control" readonly>
                  </div>
                  <div class="col-md-4 mb-3">
                    <label>PAN Number</label>
                    <input type="text" placeholder="PAN Number"
                      value="<?php echo htmlspecialchars($userdata['pan'], ENT_QUOTES, 'UTF-8'); ?>"
                      class="form-control" readonly>
                  </div>
                  <div class="col-md-4 mb-3">
                    <label>Aadhaar Number</label>
                    <input type="text" placeholder="Aadhaar Number"
                      value="<?php echo htmlspecialchars($userdata['aadhaar'], ENT_QUOTES, 'UTF-8'); ?>"
                      class="form-control" readonly>
                  </div>
                  <div class="col-md-8 mb-3">
                    <label>Location</label>
                    <input type="text" placeholder="Location"
                      value="<?php echo htmlspecialchars($userdata['location'], ENT_QUOTES, 'UTF-8'); ?>"
                      class="form-control" readonly>
                  </div>
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <select name="is_otp" class="form-control">
                      <option value="YES" <?php echo ($userdata['is_otp'] === 'YES') ? 'selected' : ''; ?>>YES
                      </option>
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <select name="whatsapp_alert" class="form-control">
                      <option value="YES" <?php echo ($userdata['whatsapp_alert'] === 'YES') ? 'selected' : ''; ?>>YES
                      </option>
                      <option value="NO" <?php echo ($userdata['whatsapp_alert'] === 'NO') ? 'selected' : ''; ?>>NO
                      </option>
                    </select>
                  </div>
                  <div class="col-md-4 mb-3">
                    ...
                    <select name="email_alert" class="form-control">
                      <option value="YES" <?php echo ($userdata['email_alert'] === 'YES') ? 'selected' : ''; ?>>YES
                      </option>
                      <option value="NO" <?php echo ($userdata['email_alert'] === 'NO') ? 'selected' : ''; ?>>NO
                      </option>
                    </select>
                  </div>
