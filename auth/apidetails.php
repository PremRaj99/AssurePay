...
<div class="page-content fade-in-up">
                                ...
                                <div class="col-md-12">
                                    <form class="row mb-4" method="POST"
                                        ...
                                        <div class="col-md-8 mb-2">
                                            ...
                                            <input type="text" placeholder="Click Generate Button for API Token"
                                                value="<?php echo htmlspecialchars($userdata['user_token'], ENT_QUOTES, 'UTF-8'); ?>"
                                                class="form-control" readonly>
                                        </div>
                                        <div class="col-md-4 mb-2">
                                            <label>&nbsp;</label>
                                            <button type="submit" name="get_api_token"
                                                class="btn btn-primary btn-block">Generate Api Token</button>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <form class="row mb-4" method="POST"
                                        ...
                                        <div class="col-md-8 mb-2">
                                            ...
                                            <input type="url" name="webhook_url" placeholder="Enter Your Webhook URL"
                                                value="<?php echo htmlspecialchars($userdata['callback_url'], ENT_QUOTES, 'UTF-8'); ?>"
                                                class="form-control" required
                                                pattern="https?://[a-zA-Z0-9.-]+\.[a-zA-Z]{2,4}/?[a-zA-Z0-9.-]*\??[a-zA-Z0-9.-]*"
                                                title="Enter a valid URL">
                                            <b style="color:red">Note: URL must include protocol (http /
                                                https)</b>
                                        </div>
                                        <div class="col-md-4 mb-2">
                                            <label>&nbsp;</label>
                                    ...
                                    <form class="row mb-4" method="POST" action="">
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <input type="text" placeholder="URL"
                                                value="https://<?php echo htmlspecialchars($server, ENT_QUOTES, 'UTF-8'); ?>/api/create-order"
                                                class="form-control" readonly>
                                            <b style="color:red">Order Timeout 30 Minutes. Order Will Be
                                                Automatically Failed After 30 Minutes.</b>
                                        </div>
                                        <div class="col-md-12 mb-4">
                                            <label>Form-Encoded Payload
                                                (application/x-www-form-urlencoded)</label>
                                            <textarea type="text" placeholder="Form-Encoded Payload (Parameter)"
                                                class="form-control" style="height: 190px;" readonly>{
  ...
  "remark2 : "testremark2,
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <textarea type="text" placeholder="Success Response" class="form-control"
                                                style="height: 230px;" readonly>
    {
    "status": true,
    ...
    "result": {
        ...
        "payment_url": "https://yourwebsite.com/payment/pay.php?data=MTIzNDU2MTcwNTA0NzUxMkyNTIy"
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <textarea type="text" placeholder="Failed Response" class="form-control"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form class="row mb-4" method="POST" action="">
                                        <div class="col-md-12 mb-2">
                                            <label>URL</label>
                                            <input type="text" placeholder="URL"
                                                value="https://<?php echo htmlspecialchars($server, ENT_QUOTES, 'UTF-8'); ?>/api/check-order-status"
                                                class="form-control" readonly>
                                        </div>
                                        <div class="col-md-12 mb-4">
                                            <label>Form-Encoded Payload
                                                (application/x-www-form-urlencoded)</label>
                                            <textarea type="text"
                                                placeholder="Post Data into Form Header into Form Header (Parameter)"
                                                class="form-control" style="height: 120px;" readonly>{
